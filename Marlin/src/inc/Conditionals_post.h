...
#if TEMP_SENSOR_0 == -6
  #define HEATER_0_USES_ADS1115
#elif TEMP_SENSOR_0 == -5 || TEMP_SENSOR_0 == -3 || TEMP_SENSOR_0 == -2
...
#if TEMP_SENSOR_BED == -6
  #define HEATER_BED_USES_ADS1115
...
#define HAS_TEMP_HOTEND   ((HAS_TEMP_ADC_0 || ENABLED(HEATER_0_USES_MAX6675) || ENABLED(HEATER_0_USES_ADS1115)) && HOTENDS)
#define HAS_TEMP_BED        1//HAS_TEMP_ADC_BED
